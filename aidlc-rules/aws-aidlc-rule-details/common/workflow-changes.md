...
4. **Update State**: Mark stage as "PENDING" in `{PROJECT_AIDLC_DOCS_ROOT}/project-state.md`
...
5. **Update State**: Mark stage as "SKIPPED" in `{PROJECT_AIDLC_DOCS_ROOT}/project-state.md`
...
3. **If Restart Chosen**:
   ...
   - Mark stage as "IN PROGRESS" in `{PROJECT_AIDLC_DOCS_ROOT}/project-state.md`
...
4. **If Confirmed**:
   ...
   - Reset all affected stages in `{PROJECT_AIDLC_DOCS_ROOT}/project-state.md`
...
3. **Update State**: Ensure `{PROJECT_AIDLC_DOCS_ROOT}/project-state.md` reflects current status
...
**On Resume**:
1. **Detect Existing Project**: Check for `{PROJECT_AIDLC_DOCS_ROOT}/project-state.md`
...
2. **Update All Tracking**: Keep `{PROJECT_AIDLC_DOCS_ROOT}/project-state.md`, plan files, and `audit.md` in sync
